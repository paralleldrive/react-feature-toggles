              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  assert({
                    ...
                    actual: (0, _getQueryFeatures.getQueryFeatures)(),
                    expected: []
                  });
                  ...
                  assert({
                    given: 'empty object',
                    should: 'return an empty array',
                    actual: (0, _getQueryFeatures.getQueryFeatures)(query),
                    expected: []
                  });
                  ...
                  assert({
                    ...
                    should: 'return an empty array',
                    actual: (0, _getQueryFeatures.getQueryFeatures)(_query),
                    expected: []
                  });
                  ...
                  assert({
                    ...
                    actual: (0, _getQueryFeatures.getQueryFeatures)(_query2),
